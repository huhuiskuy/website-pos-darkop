...
<head>
    ...
    <title>Login Back Office - DariKopi</title>
    <!-- Bootstrap 5 CSS -->
    ...
    <style>
        /* Background estetik dengan gradasi soft */
        body { 
        ...
        .login-card {
            background: #ffffff;
            width: 100%;
            max-width: 420px; /* Ukuran pas nggak kelebaran */
            border-radius: 24px; /* Lengkungan premium */
            padding: 48px 40px;
            box-shadow: 0 10px 40px rgba(138, 90, 54, 0.05); /* Shadow tipis warna coklat */
            margin: 20px;
        }
        ...
        .brand-title {
            font-size: 22px;
            font-weight: 700;
            color: #795238; /* Coklat khas DariKopi */
            line-height: 1.2;
            text-align: center;
            margin-bottom: 2px;
        }
        ...
        .welcome-title {
            font-size: 28px;
            font-weight: 800;
            color: #382A22; /* Coklat sangat gelap */
            text-align: center;
            margin-bottom: 8px;
...
<body>
    ...
    <div class="login-card">
        ...
        <form action="{{ route('login.admin.post') }}" method="POST">
            ...
            <!-- Pesan Error kalau salah password -->
            @error('username')
    ...
    <script>
        ...
        togglePasswordBtn.addEventListener('click', function () {
            ...
            // Ganti ikon SVG berdasarkan status
            if (type === 'text') {
                // Ikon Mata Dicoret (Mata Tertutup)
